      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-12">
        <div className="w-full max-w-lg">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-lg font-bold text-black">Create Account</p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-white px-3 text-black font-bold uppercase">Or continue with</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-black text-black uppercase">Full Name</label>
              <input
                type="text"
                name="name"
                value={formData.name}
            ...
            <div className="space-y-2">
              <label className="text-sm font-black text-black uppercase">Confirm Password</label>
              <input
                type="password"
          ...
          <div className="text-center border-t-4 border-black pt-4">
            <p className="text-sm text-black font-bold">
              ...
              <button onClick={() => router.push("/auth/login")} className="hover:underline uppercase">
                Sign In
              </button>
            </p>
            <p className="text-sm text-black font-bold mt-2">
              <button onClick={() => router.push("/")} className="hover:underline uppercase">
                ← Back to Home
              </button>
            </p>
          </div>
